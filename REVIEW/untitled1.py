# -*- coding: utf-8 -*-
"""
Created on Tue Feb  8 11:06:35 2022
...
# craw company info
myCraw = craw('http://kind.krx.co.kr/corpgeneral/corpList.do?method=download&searchType=13')
...
mysql_mine.query_execute(f'create table if not exists company'
            ...
            f'{columns[7]} char(50),'
            f'{columns[8]} char(10))')
mysql_mine.encoding('INVESTAR','company')
...
mysql_mine.encoding('INVESTAR','price_info')
